class TextStringConstant {
  ...
  static String dontHaveAnyAccountText = "Don't have an account?";
  static String signUpTextButtonText = "Signup";
  static String signInButtonText = "SignIn";
  static String signUpText = "Sign Up";
  static String emailText = "e-mail";
  static String repeatPasswordText = "repeat password";
  static String alreadyHaveAccount = "Already have an account ?";
  static String signInTextButtonText = "Signin";
  static String signUpButtonText = "SignUp";
  static String enjoyTheText = "Enjoy the";
  ...
  /// chat text
  static String chatTextFieldText = "Type...";
  ...
  static String callingTime = "Calling Time";
  static String callRejected = "Call Rejected";
  static String noDataFound = "No Data Found";

  ///setting text
  static String notificationText = "Notification";
  static String gameSettingsText = "Game Settings";
  static String appAppearanceText = "App Appearance";
  static String checkForUpdatesText = "Check For Updates";
